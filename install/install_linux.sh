...
curl -o "$BIN_DIR/deep-filter-0.5.6-armv7-unknown-linux-gnueabihf" https://github.com/Rikorose/DeepFilterNet/releases/download/v0.5.6/deep-filter-0.5.6-armv7-unknown-linux-gnueabihf
...
# https://github.com/Rikorose/DeepFilterNet/blob/main/models/DeepFilterNet2_onnx.tar.gz
# https://github.com/Rikorose/DeepFilterNet/blob/main/models/DeepFilterNet2_onnx_ll.tar.gz
# https://github.com/Rikorose/DeepFilterNet/blob/main/models/DeepFilterNet3_ll_onnx.tar.gz
# https://github.com/Rikorose/DeepFilterNet/blob/main/models/DeepFilterNet3_onnx.tar.gz
